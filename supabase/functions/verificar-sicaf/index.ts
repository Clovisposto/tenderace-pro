    ...
    const knownCompanies: Record<string, SicafData> = {
      '26123476000103': {
        ...
        niveis: {
          ...
          fgts: { valida: true, vencimento: '2026-07-20' },
          trabalhista: { valida: true, vencimento: '2026-10-01' },
          regularidadeEstadual: { valida: true, vencimento: '2026-07-15' },
          regularidadeMunicipal: { valida: true, vencimento: '2026-06-30' },
      ...
      '07947570000132': {
        ...
        niveis: {
          ...
          habilitacaoJuridica: true,
          regularidadeFiscalFederal: { valida: true, vencimento: '2026-09-27' },
          fgts: { valida: true, vencimento: '2026-07-25' },
          trabalhista: { valida: true, vencimento: '2026-10-01' },
          regularidadeEstadual: { valida: true, vencimento: '2026-07-13' },
