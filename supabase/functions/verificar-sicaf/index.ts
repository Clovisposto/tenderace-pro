  ...
  try {
    ...
    const knownCompanies: Record<string, SicafData> = {
      '26123476000103': {
        ...
        razaoSocial: 'PARA MEDICAMENTOS E SERVIÇOS MÉDICOS LTDA',
        ...
        niveis: {
          ...
          regularidadeFiscalFederal: { valida: true, vencimento: '2026-03-30' },
          fgts: { valida: true, vencimento: '2026-01-22' },
          trabalhista: { valida: true, vencimento: '2026-05-05' },
          regularidadeEstadual: { valida: true, vencimento: '2026-02-28' },
          regularidadeMunicipal: { valida: false, vencimento: '2026-01-13', pendencia: true },
          qualificacaoTecnica: true,
          qualificacaoEconomica: { valida: true, vencimento: '2026-06-30' },
        },
      },
      '07947570000132': {
        cnpj: '07.947.570/0001-32',
        razaoSocial: 'PARA EMPREENDIMENTOS COMERCIO E PRESTACAO DE SERVIÇOS LTDA',
        nomeFantasia: 'PARA SERVIÇOS',
        situacao: 'Credenciado',
        ...
        niveis: {
          ...
          habilitacaoJuridica: true,
          regularidadeFiscalFederal: { valida: true, vencimento: '2026-03-30' },
          fgts: { valida: true, vencimento: '2026-01-21' },
          trabalhista: { valida: true, vencimento: '2026-04-25' },
          regularidadeEstadual: { valida: true, vencimento: '2026-04-13' },
          regularidadeMunicipal: { valida: false, vencimento: '2026-01-14', pendencia: true },
          qualificacaoTecnica: true,
          qualificacaoEconomica: { valida: true, vencimento: '2026-06-30' },
        },
      },
