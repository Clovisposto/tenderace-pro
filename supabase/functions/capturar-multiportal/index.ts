      ...
      try {
        ...
        for (const item of contratacoes) {
          ...
          const licitacao = {
            ...
            municipio: item.orgaoEntidade?.municipioNome || item.municipioNome || item.unidadeOrgao?.municipioNome || item.municipio || item.orgaoEntidade?.municipio || 'Não informado',
            uf: item.orgaoEntidade?.ufSigla || item.unidadeOrgao?.ufSigla || item.ufSigla || item.uf || uf,
