...
const NAVIGATION_COMMANDS: NavigationCommand[] = [
  ...
  { keywords: ['medicamentos', 'remédios', 'remedios', 'farmácia', 'farmacia'], path: '/medicamentos', label: 'Medicamentos' },
  { keywords: ['empreendimentos', 'obras', 'construção', 'construcao'], path: '/empreendimentos', label: 'Empreendimentos' },
  { keywords: ['empresas', 'empresa', 'cnpj', 'minha empresa'], path: '/empresas', label: 'Empresas' },
