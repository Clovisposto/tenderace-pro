...
import { Briefcase, TrendingUp, FileText, Clock, RefreshCw, MapPin } from 'lucide-react';
...
const Empreendimentos = () => {
  ...
  const empreendimentos = useMemo(() => {
    ...
    return licitacoesDB
      .filter(l => l.segmento === 'Empreendimentos' && UFS_PERMITIDAS.includes(l.uf))
      .map(l => ({
        id: l.id,
        numero: l.numero,
        orgao: l.orgao,
  ...
  const handleCapturar = async () => {
    ...
    try {
      ...
      toast.success('Captura iniciada!', {
        description: `Buscando licitações de empreendimentos em ${UFS_PERMITIDAS.join(', ')}`
      });
